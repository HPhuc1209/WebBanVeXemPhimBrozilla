    ...
    public class AppController : Controller
    {
        ...
        public ActionResult Pay()
        {
            ...
            using (Bitmap bmb = (Bitmap)img.Clone()) {
                bmb.Save("C:\\Users\\84901\\Desktop\\Cinema\\WebRapPhim\\MyQR.jpg");
            }
            ...
            var UpLoadParameter = new ImageUploadParams() {
                File = new FileDescription("C:\\Users\\84901\\Desktop\\Cinema\\WebRapPhim\\MyQR.jpg")
            };
            ...
            new MailHelper().SendMail(email, "Brozilla" +
                "Cinema", body);

            var filePath = Server.MapPath("~/Images/" + "MyQR");
            if (System.IO.File.Exists("C:\\Users\\84901\\Desktop\\Cinema\\WebRapPhim\\MyQR.jpg"))
            {
                System.IO.File.Delete("C:\\Users\\84901\\Desktop\\Cinema\\WebRapPhim\\MyQR.jpg");
            }
